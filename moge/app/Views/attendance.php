...
<div class="d-flex justify-content-around summaryboard" style="background: #<?= $class[0]->COLOR; ?>">
    <div class="p-2">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">+add Meeting</button>
    </div>
    <div class="p-2 d-flex justify-content-between">
        <div class="p-2 center">
            <h2 class="f64"><?= round($avg_atd[0]->averageAtd * 100); ?>%</h2>
...
<?php if ($atdMeetings[0] == null) { ?>
    ...
    <form method="POST" action="<?= base_url('addmeeting') ?>">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="uuid" class="col-form-label">Meeting ID</label>
                            <input type="text" class="form-control" id="uuid" name="uuid" required>
                        </div>
                        <div class="mb-3">
                            <label for="meeting_order" class="col-form-label">Meeting Order</label>
                            <input type="number" class="form-control" id="meeting_order" name="meeting_order" required>
                        </div>
